...
declare module "@corbinu/couchbase" {
     ...
     */
    export class N1qlStringQuery extends N1qlQuery {
        /**
     ...
     */
    interface Bucket extends EventEmitter {
        /**
    ...
    export namespace Bucket {
         ...
         */
        interface N1qlQueryResponse extends EventEmitter {
         ...
         * An event emitter allowing you to bind to various query result set events.
         */
        interface ViewQueryResponse extends EventEmitter {
